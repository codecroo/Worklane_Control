...
const BottomNavbar = ({ onLogoutClick }) => {
    ...
    return (
        <div
            className="fixed bottom-0 left-0 w-full z-[45] pointer-events-none"
        >
            {/* Gradient Shadow */}
                    ...
                    {navItems.map((item, index) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                bg-black/50 text-white text-[11px] font-medium px-3 py-1.5
